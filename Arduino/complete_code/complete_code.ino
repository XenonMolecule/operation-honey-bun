...
const int tonePin = 3;  // for rEDI board
const int BLUE_OUT_LED = 13;
const int RED_OUT_LED = 12;
const int MOTOR = 8;
...
char *mission_impossible = "MissionImp:d=16,o=6,b=95:32d,32d#,32d,32d#,32d,32d#,32d,32d#,32d,32d,32d#,32e,32f,32f#,32g,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,g,8p,g,8p,a#,p,c7,p,g,8p,g,8p,f,p,f#,p,a#,g,2d,32p,a#,g,2c#,32p,a#,g,2c,a#5,8c,2p,32p,a#5,g5,2f#,32p,a#5,g5,2f,32p,a#5,g5,2e,d#,8d";
//char *song = "AllStar:d=4,o=5,b=40:16g.,32d.6,32b.,16b.,32a.,32g.,32g.,16c.6,32b.,32b.,32a.,32a.,16g.,32g.,32d.6,32b.,32b.,32a.,32a.,32g.,32g.,16e.,d,32g.,32g.,32d.6,32b.,32b.,32a.,32a.,32g.,32g.,16c.6,32b.,32b.,32a.,32a.,32g.,32g.,16d.6,32b.,32b.,16a.,32g.,32g.,16a.,8e";
...
void loop(void)
{
  ...
  if (pixy.ccc.numBlocks)
  {
    ...
    if (block.m_width * block.m_height > 2250 && block.m_age > 60) {
      digitalWrite(RED_OUT_LED,LOW);
      digitalWrite(BLUE_OUT_LED,HIGH);
      if (!lastStateMaskOn) {
        play_rtttl(mission_impossible);
      }
      lastStateMaskOn = true;
    } else {
      digitalWrite(RED_OUT_LED, HIGH);
      digitalWrite(BLUE_OUT_LED, LOW);

      if (!hasDispensed && !digitalRead(IR_SENSOR)) {
