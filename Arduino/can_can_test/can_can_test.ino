...
void playNote(long noteInt, long length, long mode, long breath = 25) {
  ...
  if(mode == 0) { //mode 0 sequence
    for (long i=0; i < playLoop; i++){
      buzz(3, noteFreqArr[noteInt], 20);
      delay(5);
      buzz(3, noteFreqArr[noteInt2], 20);
      delay(5);
      buzz(3, noteFreqArr[noteInt3], 20);
      delay(5);
      buzz(3, noteFreqArr[noteInt4], 20);
      delay(5);
    }
    ...
    for (long i=0; i < playLoop; i++){
      buzz(3, noteFreqArr[noteInt4], 40);
      delay(5);
      buzz(3, noteFreqArr[noteInt2], 40);
      delay(5);
    }
  }
